CREATE TABLE QUOTE (
  SYMBOL VARCHAR(255) COMMENT 'The symbol the quote is for.',
  SYMBOL_DAY DATE COMMENT 'The date of the quote.',
  BID DECIMAL(10, 2) COMMENT 'The bid of the quote.',
  ASK DECIMAL(10, 2) COMMENT 'The ask of the quote.',
  PRIMARY KEY (SYMBOL, SYMBOL_DAY)
);


INSERT INTO QUOTE (SYMBOL, SYMBOL_DAY, BID, ASK) VALUES
  -- Microsoft
